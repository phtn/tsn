export const icons = {
  ...
  evolution: {
    symbol: `<path fill="currentColor" d="M13.356 10.64c4.326-5.698 12.18-7.308 18.704-3.822-2.548 5.726-4.452 12.46-17.01 12.852-1.47.042-3.094 0-4.872-.14.252-3.598 1.428-6.58 3.178-8.89M15.666 22.358c7.56.378 11.102 3.122 13.314 6.524 1.302 2.002 2.142 4.214 3.08 6.3-9.156 4.886-20.986-.266-21.882-12.726 2.03-.154 3.864-.182 5.488-.098"/>`,
    viewBox: '0 0 42 42',
    set: 'evolution'
  }
}
